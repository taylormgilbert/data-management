...
- **Data has value beyond your current project**: 
  ...
  - for others for follow-up studies, or combining multiple datasets for meta-analyses or synthesis
  - for science on general (especially long-term ecology in a time of global change)
  - here's an [irritating video](https://www.youtube.com/watch?v=N2zK3sAtr-4) about why this is not possible with bad data management...
  
<iframe width="560" height="315" src="https://www.youtube.com/embed/N2zK3sAtr-4?si=xfnR9B3tqwmZxMEu" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
To avoid data (and relationship) decay, and to reap the benefits of good data management, it is important to consider the full _**Data Life Cycle**_.
...
Last, but not least. We haven't discussed different data formats etc, but if you are working with tabular data (i.e. spreadsheets, tables) then this short paper on **[how to keep your data Tidy](http://dx.doi.org/10.18637/jss.v059.i10)** [@Wickham2014] is for you. Following these principles will make life much easier for you once you get to the analysis step... We will cover this tomorrow.
...
This is not part of *The Data Life Cycle* per se, but it's worth remembering that there are some other aspects of data that can be important for your use case:

1. **Latency** - the time between data collection and it's availability for analysis/modelling/etc. Depending on the use case, if the latency is too long then the data may not be useful.
2. **Uncertainty** - your inference can only ever be as good as the data (**GIGO: garbage in = garbage out**). Not including uncertainty can create **bias or overconfident inference or predictions**... Unfortunately, very rarely does anyone report the uncertainty in their data... Unfortunately, there are also many reasons why **data can never be certain** - sampling variability, random and systematic instrument errors, calibration uncertainty, classification errors (e.g. species identification), transcription errors, corrupt files (or collaborators!) etc. I live by the creed *there is nothing as sinister as a certainty*. If you tell me your model has an $R^2$ of 1, I will tell you (with 100% certainty, ironically) that your model is wrong.
