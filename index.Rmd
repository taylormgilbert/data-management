...
- Monday, 4th April - Reproducible Research [@Peng2011; @Baker2016; @Markowetz2015]
- Tuesday, 5th April - Data Management [@Michener1997; @Michener2012]
- Wednesday, 6th April - GitHub, Tidy Data and Data Wrangling [@Wickham2014; @Wickham2019]
- Thursday, 7th April - Tidy Data and Data Wrangling continued (your turn) 

Friday we head off on the field trip and do a field data collection exercise...

## Deliverables (Due Thursday the 14th April) {#deliverables}

1. A draft Data Management Plan (DMP) for your Honours Project using [UCT's Online DMP Tool](https://dmp.lib.uct.ac.za/).
