...
This section is also available as a slideshow. Right click or hold `Ctrl` or `Command` and [click this link](presentations/3_reproducibility.html) to view in full screen.
...
# Get Baker data.
cridata <- read_xlsx("data/Reproducibility Survey Raw Data.xlsx", sheet = 1)
