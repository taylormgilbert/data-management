...
![_The core components of most data analysis workflows [@Wickham2019]._ ](img/tidy_workflow.png)
...
Take lots of photos (preferably geotagged)!!! It often helps you identify and fix errors later, and is great for getting context for your data or for working out why some sites have weird values etc.
...
[Here's](https://readr.tidyverse.org/reference/write_delim.html) a bunch of ways to write out different formats with `readr`. As mentioned above, check out Google Sheets options by typing `?googlesheets4::gs4_create()` into your console to find out about creating Google Sheets and `?googlesheets4::write_sheet()` for writing to sheets.
