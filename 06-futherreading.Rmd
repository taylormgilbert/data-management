...
https://doi.org/10.1073/pnas.1421412111open_in_new
...
They propose scaling up data science education through massive online open courses (MOOCs) and crowed sourced short courses in data analysis. These will be focused on teaching methods which are the most reproducible and replicable for the novice data analyst. Part of the challenge in implementing this is the need find the current most efficient statistical methods, analyses types and software for the job. The authors call this method "evidence based data analysis".
